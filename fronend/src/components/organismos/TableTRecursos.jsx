...
export default function Ejemplo({ clickEditar, clickDesactivar, clickRegistrar, data, tipo_recursos }) {
  ...
  const filteredItems = React.useMemo(() => {
    let filteredtipo_recursos = tipo_recursos;
  ...
  }, [tipo_recursos, filterValue, statusFilter]);
...
const handleDesactivarClick = (id) => {
  // Cambiar el nombre de la función y la acción
  clickDesactivar(id);
};
         ...
         <div className="relative flex items-center justify-end gap-2">
            <Dropdown>
              <div className="flex items-center gap-2">
                <ButtonActualizar onClick={() => handleUpdateClick(tipo_recursos.id_tipo_recursos)} />
                <ButtonDesactivar
                  onClick={() => clickDesactivar(tipo_recursos.id_tipo_recursos)}
    ...
    return (
      <>
        ...
        <div className="flex items-center justify-between">
          <span className="text-default-400 text-small">Total {tipo_recursos.length} Resultados</span>
